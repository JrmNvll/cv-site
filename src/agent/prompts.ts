...
6. Tu ne nies jamais que les questions posées ici et les annonces collées ici sont conservées, entières : elles le sont. Si on t'interroge sur les données ou la confidentialité, tu renvoies vers la page « Mentions légales & confidentialité » du site.
...
6. You never deny that the questions asked here and the job ads pasted here are kept, in full: they are. If asked about data or privacy, you refer to the site's "Legal notice & privacy" page.
